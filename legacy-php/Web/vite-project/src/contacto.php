    ...
    <main class="contact-container">
        <?php if ($success): ?>
            <div class="alert alert-success border-0 shadow-sm mb-4 py-3" role="alert">
                <h4 class="alert-heading h5 fw-bold">¡Envío exitoso!</h4>
                <p class="mb-0 small text-white-50"><?= htmlspecialchars($success) ?></p>
            </div>
        <?php endif; ?>

        <?php if ($errors): ?>
            <div class="alert alert-danger border-0 shadow-sm mb-4 py-3" role="alert">
                <h4 class="alert-heading h5 fw-bold text-danger">⚠️ Por favor, corrige lo siguiente:</h4>
        ...
        <form id="contactForm" method="post" action="contacto.php" novalidate>
            ...
            <button type="submit" class="btn btn-primary w-100 py-2 mt-2">Enviar mensaje</button>
        </form>
    </main>
